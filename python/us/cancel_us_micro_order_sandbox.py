...
from utils.us_micro_order_request import cancel_micro_order_sandbox


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Cancel a sandbox order for a US micro order.")
...
def main() -> int:
    ...
    row = cancel_micro_order_sandbox(
        args.micro_order_id,
        reason=args.reason,
        created_by=args.created_by,
        dry_run=args.dry_run,
    )
    print("[US Micro Order Sandbox Cancel]")
