...
DEFAULT_FILES = [
    ...
    "outputs/operational_daily_cycle_status.json",
    "outputs/ops_operator_notes.json",
    ...
    "outputs/shadow_quality_risk_guard_repeatability_report.json",
    "data/history/ranking_snapshot_inventory.csv",
    "data/history/ranking_snapshot_inventory.md",
    ...
    "serving/intraday_recommendations.json",
