...
> **2026-05-27 기준**
> - Lee_trader_rule: 2026-05-21 종료. 문서는 이력 보관용으로만 유지하지 않음(삭제됨).
> - Lee_trader_us: 미운영. 모듈 문서 전체 삭제됨.
...
- 목적: AI 예측, 랭킹, 자동매매 후보 해석과 실자동매매 운영 흐름 정리
...
- 우선 문서:
  ...
  - [FINANCIAL_MOMENTUM_DESIGN.md](</d:/ai/lee_trader/doc/modules/Lee_trader_ai/FINANCIAL_MOMENTUM_DESIGN.md>) — 재무 모멘텀 설계
- 운영 중요도: **매우 높음 (주력 서비스)**
- 갱신 트리거:
...
- 목적: walk-forward, prediction history, outcome, 검증 흐름 정리
...
### Lee_trader_rule *(종료 — 2026-05-21)*

- 상태: **서비스 종료** (`RULE_LIVE_ENABLED=0`)
- 사유: KR AI 주력 집중 결정, 수동매매로 전환
- 코드: `python/rule_*.py` 유지 (재개 시 사용)
- 문서: 전체 삭제 (이력은 `doc/PRD.md` §13 참조)
...
5. 모듈을 가로지르는 변경이면 `doc/PRD.md`를 같이 갱신합니다.

## Reference

- 전체 PRD: [doc/PRD.md](</d:/ai/lee_trader/doc/PRD.md>)
